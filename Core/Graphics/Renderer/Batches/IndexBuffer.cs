...
{
	public class IndexSegment : ArrayHandler<uint>
	{
		public IndexSegment(DistributedArray<uint> parent, int offset, int size)
	...
	public class IndexBuffer : DistributedArray<uint>
    {
		/// <summary>
		...
		public void UploadAllHeap()
		{
			...
			Gl.BufferData(BufferTargetARB.ArrayBuffer, Count * sizeof(uint), ToArray(), BufferUsageARB.StaticDraw);
