...
namespace pEngine.Utils.Math
{
	...
	public struct Matrix : IEquatable<Matrix>
	{
		...
		public static void CreateRotationX(Angle angle, out Matrix result)
		{
			float cos = (float)System.Math.Cos(angle.Radians);
			float sin = (float)System.Math.Sin(angle.Radians);
		...
		public static Matrix CreateRotationX(Angle angle)
		{
			Matrix result;
		...
		/// <param name="angle">The counter-clockwise angle in radians.</param>
		/// <param name="result">The resulting Matrix4 instance.</param>
		public static void CreateRotationY(Angle angle, out Matrix result)
		{
			float cos = (float)System.Math.Cos(angle.Radians);
			float sin = (float)System.Math.Sin(angle.Radians);
		...
		/// <param name="angle">The counter-clockwise angle in radians.</param>
		/// <returns>The resulting Matrix4 instance.</returns>
		public static Matrix CreateRotationY(Angle angle)
		{
			Matrix result;
		...
		/// <param name="angle">The counter-clockwise angle in radians.</param>
		/// <param name="result">The resulting Matrix4 instance.</param>
		public static void CreateRotationZ(Angle angle, out Matrix result)
		{
			float cos = (float)System.Math.Cos(angle.Radians);
			float sin = (float)System.Math.Sin(angle.Radians);
		...
		/// <param name="angle">The counter-clockwise angle in radians.</param>
		/// <returns>The resulting Matrix4 instance.</returns>
		public static Matrix CreateRotationZ(Angle angle)
		{
			Matrix result;
		...
		/// <param name="left">left-hand operand</param>
		/// <param name="right">right-hand operand</param>
		/// <returns>A new Vector which holds the result of the multiplication</returns>
		public static Vector2i operator *(Vector2i left, Matrix right)
		{
			var v = Matrix.Mult(new Vector4(left.X, left.Y, 0, 0), right);
		...
		{
			var v = Matrix.Mult(new Vector4(left.X, left.Y, 1, 1), right);
		...
		/// <param name="right">right-hand operand</param>
		/// <returns>A new Vector which holds the result of the multiplication</returns>
		public static Vector3i operator *(Vector3i left, Matrix right)
		{
			var v = Matrix.Mult(new Vector4(left.X, left.Y, left.Z, 1), right);
		...
		{
			var v = Matrix.Mult(new Vector4(left.X, left.Y, left.Z, 0), right);
		...
		/// <param name="right">right-hand operand</param>
		/// <returns>A new Vector which holds the result of the multiplication</returns>
		public static Vector4i operator *(Vector4i left, Matrix right)
		{
			var v = Matrix.Mult(new Vector4(left.X, left.Y, left.Z, left.W), right);
